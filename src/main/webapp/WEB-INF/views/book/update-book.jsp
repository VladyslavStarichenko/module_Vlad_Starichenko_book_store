...
<div class="container">
    <h2 class="heading"> Updating Book: ${title} </h2>
    <hr>
        ...
        <fieldset class="form-group">
            ...
            <div class="btn-group" style=" margin-top: 20px;">
                    ...
                    <button type="button" class="btn btn-warning dropdown-toggle" data-bs-toggle="dropdown"
                            aria-expanded="false">
                        Choose necessary addresses
                    </button>

                <ul class="dropdown-menu" id="streets">
                    <c:forEach items="${addresses}" var="address">
                        <li><input name="Address" type="checkbox" value="${address.addressName}"/>${address.addressName}
                        </li>
                    </c:forEach>
                    <li>
                        <button type="button" class="btn btn-success" id="getStreets">+</button>
                    </li>
                </ul>
